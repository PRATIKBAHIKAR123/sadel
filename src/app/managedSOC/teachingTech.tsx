...
const TeachingTechCarousel = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: "We use tools like Microsoft Sentinel, Defender for Endpoint, and Cloud App Security to: Correlate data from multiple sourcesDetect threats using AI and behavioral analytics"
    },
    {
      id: 3,
      icon: <Presentation className="w-12 h-12 text-blue-600" />,
      title: "Scalable, Flexible Integration",
      description: "We integrate SOC services into your existing tech stack (on-prem, cloud, or hybrid). Whether you're a small business or large enterprise, the solution scales accordingly."
    },
    {
      id: 4,
  ...
  return (
    <div className="w-full bg-primary relative pb-38 my-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {getVisibleSlides().map((slide, index) => (
                <div
                  ...
                  className="bg-white p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 min-h-[220px] sm:min-h-[260px] md:min-h-[280px] flex flex-col items-center text-center gap-4"
                ...
                >
                  ...
                  {/* Title */}
                  <h3 className="text-center justify-center text-black text-2xl font-medium font-['Urbanist'] leading-[27.11px]">
                    {slide.title}
                  </h3>
                  {/* Description */}
                  <p className="text-center justify-center text-black text-base font-normal font-['Urbanist'] leading-[23px]">
                    {slide.description}
                  </p>
                </div>
              ))}
