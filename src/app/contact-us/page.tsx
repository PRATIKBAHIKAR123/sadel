...
export default function ContactPage() {
    return (
        <div className="w-full min-h-screen">
            {/* Hero Section */}
            <div className="bg-[#8a78bd] py-8 md:py-12 px-4">
                <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-20 relative">
                    {/* Left: Contact Info */}
                    <Fade direction="left" triggerOnce>
                        <div className="flex-1 space-y-6 md:space-y-10">
                            <h1 className="text-3xl md:text-5xl ml-0 md:ml-10 font-bold text-white font-['Urbanist'] leading-tight mb-4 text-center md:text-left">
                                Get in touch.
                            </h1>
                            <p className="text-white ml-0 md:ml-10 text-base md:text-lg mb-8 text-center md:text-left">
                    ...
                    <Fade direction="right" triggerOnce className="w-full md:w-[440px] md:absolute md:right-0 md:transform md:translate-y-1/2">
                        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-10 mt-8 md:mt-0">
                            <form className="space-y-4 md:space-y-6">
                                <div>
                                    <input type="text" placeholder="Your name" className="w-full px-4 py-3 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8a78bd] focus:border-transparent text-sm" />
                                </div>
                                <div>
                                    <input type="email" placeholder="Email address" className="w-full px-4 py-3 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8a78bd] focus:border-transparent text-sm" />
                                </div>
                                <div>
                                    <input type="text" placeholder="Company (optional)" className="w-full px-4 py-3 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8a78bd] focus:border-transparent text-sm" />
                                </div>
                                <div>
                                    <input type="text" placeholder="Phone number (optional)" className="w-full px-4 py-3 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8a78bd] focus:border-transparent text-sm" />
                                </div>
                                <div>
                                    <input type="text" placeholder="Subject" className="w-full px-4 py-3 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8a78bd] focus:border-transparent text-sm" />
                                </div>
                                <div>
                                    <textarea placeholder="Message" rows={4} className="w-full px-4 py-3 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8a78bd] focus:border-transparent text-sm" />
                                </div>
                                <div className="flex justify-center md:justify-end">
                                    <Button type="submit" className="bg-[#8a78bd] hover:bg-[#6f5ea0] text-white font-semibold px-12 md:px-16 py-3 rounded-md transition-colors shadow-none w-full md:w-auto">Send</Button>
                                </div>
                            </form>
                        </div>
                    </Fade>
            ...
            <div className="max-w-5xl mx-auto py-12 md:py-20 px-4">
                <div className="space-y-6 md:space-y-8">
                    <div className="flex items-center gap-3 md:gap-4">
                        <span className="bg-[#8a78bd] p-2 md:p-3 rounded-full flex items-center justify-center">
            ...
            <div className="bg-[#a895d2] py-12 md:py-20 px-4">
                <div className="max-w-5xl mx-auto">
                    <Fade direction="left" triggerOnce>
                        <div className="text-2xl md:text-4xl font-bold text-white font-['Urbanist'] mb-2 text-center md:text-left">Contact us</div>
                        <p className="text-lg md:text-xl text-white font-['Urbanist'] mb-8 md:mb-10 text-center md:text-left">Get in touch and let us know how we can help.</p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8">
                            ...
                            <div className="bg-white rounded-2xl p-6 md:p-8 shadow flex flex-col items-start min-h-[200px] md:min-h-[220px]">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="bg-black text-primary rounded-full p-2 md:p-3 flex items-center justify-center">
                            ...
                            <div className="text-gray-600 mb-4 text-sm md:text-base">We&apos;d love to talk about how we can work together.</div>
                                <Button  className="bg-[#8a78bd] hover:bg-[#6f5ea0] text-white px-4 md:px-6 py-2 md:py-3 rounded-full  font-semibold text-sm md:text-base w-full md:w-auto">
                                    Contact Sales
                        ...
                        <div className="flex flex-col md:flex-row gap-6 md:gap-8 mt-8">
                            <div className="flex-1 rounded-2xl p-6 md:p-8 flex flex-col gap-3 md:gap-4 bg-transparent">
                                <div className="flex items-center gap-3">
                                    <span className="bg-[#8a78bd] p-2 rounded-full flex items-center justify-center">
                    ...
                    <Fade direction="right" triggerOnce>
                        <div className="flex-1 flex flex-col items-center md:items-start">
                            <div className="text-2xl md:text-4xl font-bold mb-2 text-center md:text-left">
                                <span className="text-primary">We Work </span><span className="text-black">Worldwide.</span>
                            </div>
                    ...
                    <Fade direction="up" triggerOnce>
                        ...
                        <form className="flex flex-1 flex-col gap-2 md:items-end w-full">
                            <div className="flex w-full md:w-[380px] bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden flex-col md:flex-row">
                                ...
                                <button
                                    type="submit"
                                    className="bg-[#8a78bd] w-full md:w-[135px] hover:bg-[#6f5ea0] text-white font-semibold px-6 py-3 md:py-2 text-sm"
                                >
                                    Sign Up
                                </button>
                            </div>
                            <p className="text-xs text-gray-500 mt-1 text-center md:text-center w-full">
                                You can unsubscribe at any time. Read our <a href="#" className="text-[#8a78bd]">privacy policy</a>.
                            </p>
                        </form>
