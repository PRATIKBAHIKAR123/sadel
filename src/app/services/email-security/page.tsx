    ...
    const faqData = [
        {
            ...
            answer: "The best email security service depends on your organization's specific needs. Sadel offers comprehensive email protection including advanced threat detection, data loss prevention, encryption, and user training. Our solutions integrate seamlessly with Microsoft 365 and Google Workspace while providing enterprise-grade security features."
        },
        {
            question: "What are the different types of email security?",
            answer: "Email security encompasses multiple layers including spam filtering, phishing protection, malware detection, data loss prevention (DLP), encryption, authentication, and user awareness training. Sadel provides all these protections through our integrated email security platform designed for modern business environments."
        },
        {
            question: "How much does email security cost?",
            answer: "Email security costs vary based on your organization size, deployment model, and specific requirements. Sadel offers flexible pricing models including per-user licensing and enterprise packages. Contact our team for a customized quote that fits your budget and security needs."
        },
        {
            question: "Does Office 365 have email security?",
            answer: "While Office 365 includes basic email security features, they may not be sufficient for comprehensive protection against advanced threats. Sadel enhances Office 365 security with additional layers including advanced threat protection, better phishing detection, data loss prevention, and user training programs."
        }
    ];
                    ...
                    <Fade direction="up" triggerOnce>
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-gray-700 text-base sm:text-lg mb-6 max-w-xl">
                                Sadel Email Security protects your inbox with advanced threat detection, comprehensive data protection, and seamless integration with your existing email infrastructure.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
                                <Button 
                                    onClick={handleContactRedirect}
                                    className="bg-yellow-400 hover:bg-yellow-500 text-black px-6 py-3 rounded-lg font-semibold w-full sm:w-auto"
                                >
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-base sm:text-lg">
                                Sadel Email Security scans messages and attachments for sensitive material, including seamlessly integrated encryption, to safeguard confidential information and simplify compliance requirements.
                            </p>
                        </div>
                        {/* Right: Illustration */}
